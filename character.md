...
<div class="character-id-card">
    <div class="id-card-content">
        <div class="id-profile-pic">
            <img src="https://raw.githubusercontent.com/FFFox-ST-Manager/Weylandpedia/main/idcards/sayori.webp" alt="Sayori">
        </div>
        <div class="id-info id-name">
            <span class="id-label">Name:</span>
        ...
        <div class="id-info id-major">
            ...
            <span class="id-value">Weyland Professor</span>
        </div>
        <div class="id-info id-hobbies">
            <span class="id-label">Lucky Hint:</span>
            <span class="id-value"></span>
...
<div class="character-id-card">
    <div class="id-card-content">
        <div class="id-profile-pic">
            <img src="https://raw.githubusercontent.com/FFFox-ST-Manager/Weylandpedia/main/idcards/sunny.webp" alt="Sunny">
        </div>
        <div class="id-info id-name">
            <span class="id-label">Name:</span>
            <span class="id-value">Sunny</span>
        </div>
        <div class="id-info id-age">
            <span class="id-label">Age:</span>
        ...
        <div class="id-info id-major">
            <span class="id-label">Year & Major:</span>
            <span class="id-value">Freshman, Music Perf</span>
        </div>
        <div class="id-info id-hobbies">
            <span class="id-label">Lucky Hint:</span>
            <span class="id-value"></span>
...
<div class="character-id-card">
    <div class="id-card-content">
        ...
        <div class="id-info id-major">
            <span class="id-label">Year & Major:</span>
            <span class="id-value">Freshman, Bio</span>
        </div>
        <div class="id-info id-hobbies">
            <span class="id-label">Lucky Hint:</span>
            <span class="id-value"></span>
...
<div class="character-id-card">
    <div class="id-card-content">
        ...
        <div class="id-info id-major">
            <span class="id-label">Year & Major:</span>
            <span class="id-value">Freshman, Marine Bio</span>
        </div>
        <div class="id-info id-hobbies">
            <span class="id-label">Lucky Hint:</span>
            <span class="id-value"></span>
